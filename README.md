...
The core library, CLI, Pi integration, and VS Code extension are versioned independently. The private Pi integration ships from this Git repository rather than a package registry. Create the stable local VSIX path with:
